...
namespace TouchScript.Gestures
{
    ...
    public class TapGesture : Gesture
    {
        ...
        private TimedSequence<Pointer> pointerSequence = new();
        ...
        protected override void pointersPressed(IList<Pointer> pointers)
        {
            ...
            if (pointersNumState is PointersNumState.PassedMaxThreshold or PointersNumState.PassedMinMaxThreshold)
            {
            ...
            if (NumPointers == pointers.Count)
            {
                ...
                if (tapsDone == 0)
                {
                    ...
                    if (timeLimit < float.PositiveInfinity) _waitCo = StartCoroutine(wait());
                }
        ...
        public override bool CanBePreventedByGesture(Gesture gesture) => IsFriendly(gesture);//TODO: this line was added in our previous version, why?
        ...
        protected override void onRecognized()
        {
            ...
            if (UseSendMessage && SendMessageTarget) SendMessageTarget.SendMessage(TAP_MESSAGE, this, SendMessageOptions.DontRequireReceiver);
        ...
        private IEnumerator wait()
        {
            ...
            if (State is GestureState.Idle or GestureState.Possible) setState(GestureState.Failed);
        }
    }
}