...
namespace TouchScript.Gestures.TransformGestures
{
    ...
    public class ScreenTransformGesture : TwoPointTransformGestureBase
    {
        ...
        {
			gestureSampler.Begin();//TODO: this line was commented in our previous version, why?
			...
			gestureSampler.End();//TODO: this line was commented in our previous version, why?
        }
        ...
        /// <inheritdoc />
        protected override float doScaling(Vector2 oldScreenPos1, Vector2 oldScreenPos2, Vector2 newScreenPos1, Vector2 newScreenPos2, ProjectionParams projectionParams) => (newScreenPos2 - newScreenPos1).magnitude / (oldScreenPos2 - oldScreenPos1).magnitude;
