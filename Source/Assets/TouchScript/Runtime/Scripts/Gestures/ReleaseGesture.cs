...
namespace TouchScript.Gestures
{
    ...
    public class ReleaseGesture : Gesture
    {
        ...
        /// </summary>
		public GestureEvent OnRelease = new();
		...
		public override bool ShouldReceivePointer(Pointer pointer)
        {
            ...
            return pointer.GetPressData().Target == cachedTransform;
        }
        ...
        protected override void onRecognized()
        {
            ...
            if (UseSendMessage && SendMessageTarget) SendMessageTarget.SendMessage(RELEASE_MESSAGE, this, SendMessageOptions.DontRequireReceiver);
