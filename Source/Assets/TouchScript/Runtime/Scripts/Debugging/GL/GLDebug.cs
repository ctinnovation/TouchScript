...
namespace TouchScript.Debugging.GL
{
    ...
    {
        public static readonly Color MULTIPLY = new(0, 0, 0, 0);
        public static readonly Vector2 DEFAULT_SCREEN_SPACE_SCALE = new(10, 10);
        ...
        {
            return drawFigure(id, new List<Line> {new(start, end)}, color ?? Color.white, duration, depthTest);
        }
        ...
        {
            return drawFigureScreenSpace(id, new List<Line> {new(start, end)}, color ?? Color.white, duration);
        }
        ...
        {
            var lines = new List<Line> {new(start, end)};
        ...
        private static List<Line> createArrowLines(Vector3 start, Vector3 end, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20)
        {
            ...
            {
                new(start, end),
                new(end, end + right * arrowHeadLength),
                new(end, end + left * arrowHeadLength)
            };
        }
