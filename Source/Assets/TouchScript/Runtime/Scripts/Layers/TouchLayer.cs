...
namespace TouchScript.Layers
{
    ...
    public abstract class TouchLayer : MonoBehaviour
    {
        ...
        [HideInInspector] public int layerLevel = -1;
        ...
        private List<HitTest> tmpHitTestList = new(10);
        ...
        {
            hit = default;
            if (!enabled || !gameObject.activeInHierarchy) return HitResult.Miss;
            if (Delegate != null)
            {
        ...
        private IEnumerator lateAwake()
        {
            ...
            manager.AddLayer(this, layerLevel, false);
        }
