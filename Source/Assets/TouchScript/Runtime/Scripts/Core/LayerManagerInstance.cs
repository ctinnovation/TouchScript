...
namespace TouchScript.Core
{
    ...
    internal sealed class LayerManagerInstance : MonoBehaviour, ILayerManager
    {
        ...
        public static ILayerManager Instance
        {
            get
            {
                ...
                if (!instance)
                {
                    ...
                    var objects = FindObjectsByType<LayerManagerInstance>(FindObjectsSortMode.None);
                    if (objects.Length == 0)
                    {
        ...
        /// <inheritdoc />
        public bool HasExclusive => exclusiveCount > 0;
        ...
        private HashSet<int> exclusive = new();
        ...
        private List<Transform> tmpList = new(20);
        ...
        /// <inheritdoc />
        public bool IsExclusive(Transform target) => exclusive.Contains(target.GetHashCode());
