...
{
    [CustomEditor(typeof(MultiWindowCursorManager))]
    internal sealed class MultiWindowCursorManagerEditor : UnityEditor.Editor
    {
        ...
        public static readonly GUIContent TARGET_DISPLAY_HEADER = new GUIContent("Target Display", "The target display from which pointers are displayed.");
        ...
        private SerializedProperty useDPI, cursorSize, cursorPixelSize, targetDisplay;
        private SerializedProperty cursorsProps;
        
        private MultiWindowCursorManager instance;

        private void OnEnable()
        {
            instance = target as MultiWindowCursorManager;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.IntPopup(targetDisplay, targetDisplayNames, targetDisplays, TARGET_DISPLAY_HEADER);
