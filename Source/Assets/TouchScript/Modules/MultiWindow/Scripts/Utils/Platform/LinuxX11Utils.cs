    ...
    public static class LinuxX11Utils
    {
        ...
        public static void GetWindowsOfProcess(int pid, List<IntPtr> procWindows)
        {
            ...
            if (atomPID != None)
            {
                ...
                {
                    if (XGetWindowProperty(display, window, atomPID, 0, 1, false, AtomXACardinal, out var type,
            ...
            {
                Debug.LogWarning($"[Linux]: Failed to retrieve atom for '{AtomNetWmPID}'");
            }
            ...
            Debug.Log($"[Linux]: Found {procWindows.Count} windows");
        }
        ...
        private static void GetChildWindows(IntPtr display, IntPtr parent, List<IntPtr> result)
        {
            ...
            {
                Debug.LogWarning("[Linux]: XQueryTree failed");
                return;
            }
